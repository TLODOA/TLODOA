...
CREATE TABLE "UserInfos" (
    ...
    FOREIGN KEY("iconProfileName") REFERENCES "Icon"("name")
);
...
CREATE INDEX "userinfos_iconprofilename_index" ON "UserInfos"("iconProfileName");
...
CREATE TABLE "ObjectInfos" (
    ...
    "time_init" TEXT NOT NULL,  -- store ISO timestamp string
    "time_end" TEXT,
